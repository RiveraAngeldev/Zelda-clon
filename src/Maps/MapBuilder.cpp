...
shared_ptr<Section> MapBuilder::createSection(int startingPixelMapX, int startingPixelMapY, shared_ptr<Link> &linkPtr, ofImage pixelMap) {
    ...
    for (int y = startingPixelMapY; y < startingPixelMapY + VERTICAL_COUNT; y++) {
        ...
        for (int x = startingPixelMapX; x < startingPixelMapX + HORIZONTAL_COUNT; x++) {
            ...
            //Dungeon Exit cant exit without this.
            else if (currentPixel == entityPixelColors.DUNGEON_EXIT) {
                column = 4;
                row = 10;
                isADoor = true;
            ...
            //Up Arrow
            else if (currentPixel == tilePixelColors.UP_ARROW) 
            {
                column = 6;
                row = 9;
                collidable = true;
            ...
            //Down Arrow
            else if (currentPixel == tilePixelColors.DOWN_ARROW) {
                column = 7;
                row = 9;
                collidable = true;
            }
            //Left Arrow
            else if (currentPixel == tilePixelColors.LEFT_ARROW) {
                column = 0;
                row = 10;
                collidable = true;
            }
            //Right Arrow
            else if (currentPixel == tilePixelColors.RIGHT_ARROW) {
                column = 1;
                row = 10;
                collidable = true;
            }
